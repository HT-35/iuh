    ...
    if (res.status) {
      ...
      const template = `          <div class="">
            ...
            <div class="mb-3 mt-3 row">
              ...
              <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input value="2024-03-05" type="text" class="form-control border border-dark"
            ...
            <div class="mb-3 mt-3 row">
              ...
              <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input  type="date" value="${newDate}" class="form-control border border-dark"
