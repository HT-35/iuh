    ...
    if (res.status) {
      ...
      const template = `          <div class="">
            ...
            <div class="mb-3 mt-3 row">
              ...
              <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input value='${NgaySinh}' type="date" class="form-control border border-dark"
            ...
            <div class="mb-3 mt-3 row">
              ...
              <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input value='' type="email" class="form-control border border-dark"
