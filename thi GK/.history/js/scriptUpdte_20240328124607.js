document.addEventListener("DOMContentLoaded", () => {
  ...
  const convertDate = (date) => {
    ...
    var ngaySinhMoi = namFormatted + "/" + thangFormatted + "/" + namFormatted;
    ...
    if (res.status) {
      ...
      const template = `          <div class="">
            ...
            <div class="mb-3 mt-3 row">
              ...
              <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input value="2013-01-08" type="date" class="form-control border border-dark"
