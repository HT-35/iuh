document.addEventListener("DOMContentLoaded", () => {
  ...
  const convertDate = (date) => {
    ...
    const format = (date) => {
      ...
      // var ngaySinhMoi = ngayFormatted + "/" + thangFormatted + "/" + namFormatted;
      var ngaySinhMoi =
        namFormatted + "-" + thangFormatted + "-" + ngayFormatted;
  ...
  btnFind.addEventListener("click", async () => {
    ...
    if (res.status) {
      ...
      const newDate = await convertDate(NgaySinh);
      console.log(newDate);
      ...
      const template = `          <div class="">
            ...
            <div class="mb-3 mt-3 row">
              ...
              <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input value="${newDate}" type="date" class="form-control border border-dark"
      ...
      btnUpdate.addEventListener("click", async () => {
        ...
        if (resUpdate.status == true) {
          ...
          const formatDate = convertDate(NgaySinh);
