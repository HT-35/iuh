            ...
            <form action="#" class="">
              <div class="mb-3 mt-3 row">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                  <input type="text" value="${product}" class="form-control border border-dark" id="name-product" placeholder=""
                    name="name-product">
                </div>
              </div>
              ...
              <div class="mb-3 mt-3 row">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6"><input value="${product}" type="number"
