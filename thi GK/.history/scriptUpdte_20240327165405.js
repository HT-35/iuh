  ...
  btnFind.addEventListener("click", async () => {
    ...
    if (res.status) {
      ...
      btnUpdate.addEventListener("click", async () => {
        ...
        if (res.status == true) {
          const templateSuccess = `              <div class="mb-3 mt-3 row text-center mt-5 ">
                <div class="col-12 col-sm122 col-md-12 col-lg-12  ">

                <p class="text-success" >Cập Nhật Thành Công</p>
              </div>`;
      ...
      const template = `              <div class="mb-3 mt-3 row text-center">
                ...
                <p class="text-bg-danger text-dark"  >Lỗi : ${data}</p>
              </div>`;
      updateProduct.insertAdjacentHTML("beforeend", template);
    }
  });
